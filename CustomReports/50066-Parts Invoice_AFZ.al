    ...
    dataset
    {
        dataitem(DataItem1; "Sales Invoice Header")
        {
            ...
            begin
                ...
                "Sales Invoice Header"."Bill-to Name" := "Sales Invoice Header"."Bill-to Name" + "Sales Invoice Header"."Bill-to Name 2";
