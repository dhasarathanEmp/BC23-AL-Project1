report 50032 "Order Acknowledgement"
{
    ...
    dataset
    {
        dataitem(DataItem1; "Sales Header")
        {
            ...
            column(Reference; salesheader."Your Reference")
            {
            }
            ...
            dataitem(DataItem10; "Sales Line")
            {
                ...
                column(InvDiscount; "Sales Line"."Inv. Discount Amount")
                {
                }
                column(ITC; "Sales Line"."Item Category Code")
                {
                }
                ...
                column(OrderedPart; "Sales Line".LastPartNumber)
                {
                }
                ...
                column(LocationHdr; "Sales Line"."Location Code")
                {
                }
                ...
                column(LastPartNumber_SalesLine; "Sales Line".LastPartNumber)
                {
                }
                column(CustomerSerialNo_SalesLine; "Sales Line"."Customer Serial No")
                {
                }
                ...
                dataitem(DataItem77; "Company Information")
                {
                    ...
                    column(CountryRegionCode_CompanyInformation; "Company Information"."Country/Region Code")
                    {
                    }
                ...
                begin
                    ...
                    VatTax += "Sales Line"."Amount Including VAT" - "Sales Line"."Line Amount";
                    ...
                    IF "Sales Line".Type = "Sales Line".Type::Item THEN
                        IF "Sales Line"."Gen. Prod. Posting Group" = 'CD' THEN
                            PartNo := "Sales Line"."No."
                        ELSE BEGIN
                            PartNo := "Sales Line"."No.";
                            Compstr1 := COPYSTR(PartNo, 1, 2);
                            Compstr2 := COPYSTR("Sales Line"."Gen. Prod. Posting Group", 1, 1) + '#';
                            IF Compstr1 = Compstr2 THEN
                                PartNo := COPYSTR("Sales Line"."No.", 3, STRLEN("Sales Line"."No."));
                        END;
                    //IF01
